...
export {
  BulkDeleteSpecializationsByIdBody,
  DeleteSpecializationByIdParam,
} from './dtos/delete-specialization.dto';
...
export type { IBulkDeleteSpecializationsByIdPayload } from './payloads/delete-specialization.payload';
