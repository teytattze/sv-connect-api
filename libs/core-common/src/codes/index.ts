export { GeneralCode } from './general.code';

export { AccountsCode } from './accounts.code';
...
export { StudentsCode } from './students.code';
export { SupervisorsCode } from './supervisors.code';

export type { ICode } from './interface.code';
